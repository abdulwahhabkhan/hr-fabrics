...
{
    public static function getExpenses($start_date, $end_date, $account = 0)
    {
    ...
    public static function paymentTotalReceived($start_date, $end_date)
    {
    ...
    /**
     * @return array {total_debit,total_credit, transaction, balance,journal}
     */
