...
class DropdownNotification extends React.Component {
	...
	render() {
		return (
			<Dropdown /*isOpen={this.state.dropdownOpen} toggle={this.toggle}*/ className="dropdown" as="li">
				<Dropdown.Toggle className="f-s-14" as="a">
					<Icon icon={"solar:bell-bold-duotone"} />
					<span className="label">5</span>
				</Dropdown.Toggle>
				<Dropdown.Menu className="media-list dropdown-menu-right" as="ul">
					<Dropdown.Item className="dropdown-header" tag="li" header>NOTIFICATIONS (5)</Dropdown.Item>
					<Dropdown.Item className="media">
					...
					<Dropdown.Item className="dropdown-footer text-center">
						View more
					</Dropdown.Item>
				</Dropdown.Menu>
			</Dropdown>
